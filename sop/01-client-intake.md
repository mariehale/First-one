...
Do these steps in order, every time. Same order, every client — that consistency is what makes step 3 (the AI assessment) accurate.
...
Next: `sop/02-photo-capture-protocol.md` (do this *on* the first visit, before anything gets touched).
